...
class test_ids_stuff(ImporterCase):
    ...
    def test_create_with_id(self):
        self.assertEqual(
            ...
            error(1, "Unknown database identifier '42'"))
    ...
    def test_wrong_format(self):
        self.assertEqual(
            ...
            error(1, "'50%' does not seem to be an integer for field 'unknown'"))
...
class test_integer_field(ImporterCase):
    ...
    def test_nonsense(self):
        self.assertEqual(
            ...
            error(1, "'zorglub' does not seem to be an integer for field 'unknown'"))
...
class test_float_field(ImporterCase):
    ...
    def test_nonsense(self):
        self.assertEqual(
            ...
            error(1, "'foobar' does not seem to be a number for field 'unknown'"))
...
class test_selection(ImporterCase):
    ...
    def test_invalid(self):
        self.assertEqual(
            ...
            error(1, "Value 'Baz' not found in selection field 'unknown'"))
        self.cr.rollback()
        self.assertEqual(
            self.import_(['value'], [[42]]),
            error(1, "Value '42' not found in selection field 'unknown'"))
...
class test_m2o(ImporterCase):
    ...
    def test_fail_by_implicit_id(self):
        ...
        self.assertEqual(
            ...
            error(1, "No matching record found for name '%s' in field 'unknown'" % integer_id1))
    ...
    def test_sub_field(self):
        ...
        self.assertEqual(
            ...
            error(1, "Can not create Many-To-One records indirectly, import the field separately"))

    def test_fail_noids(self):
        self.assertEqual(
            self.import_(['value'], [['nameisnoexist:3']]),
            error(1, "No matching record found for name 'nameisnoexist:3' in field 'unknown'"))
        self.cr.rollback()
        self.assertEqual(
            self.import_(['value/id'], [['noxidhere']]),
            error(1, "No matching record found for external id 'noxidhere' in field 'unknown'"))
        self.cr.rollback()
        self.assertEqual(
            self.import_(['value/.id'], [[66]]),
            error(1, "No matching record found for database id '66' in field 'unknown'"))
...
class test_m2m(ImporterCase):
    ...
    def test_noids(self):
        self.assertEqual(
            ...
            error(1, "No matching record found for database id '42' in field 'unknown'"))
    ...
    def test_noxids(self):
        self.assertEqual(
            ...
            error(1, "No matching record found for external id 'noxidforthat' in field 'unknown'"))
    ...
    def test_nonames(self):
        self.assertEqual(
            ...
            error(1, "No matching record found for name 'wherethem2mhavenonames' in field 'unknown'"))
...
class test_o2m(ImporterCase):
    ...
    def test_name_get(self):
        s = 'Java is a DSL for taking large XML files and converting them to' \
            ' stack traces'
        self.assertEqual(
            self.import_(
                ['const', 'value'],
                [['5', s]]),
            error(1, "No matching record found for name '%s' in field 'unknown'" % s))
