...
class TestACL(common.TransactionCase):
    ...
    def test_field_visibility_restriction(self):
        ...
        self.assertNotEqual(view_arch.xpath("//field[@name='accuracy']"), [],
        ...
        self.assertEqual(view_arch.xpath("//field[@name='accuracy']"), [],
    ...
    def test_field_crud_restriction(self):
        ...
        self.assertTrue(self.res_partner.read(self.cr, self.demo_uid, [1], ['bank_ids']))
        self.assertTrue(self.res_partner.write(self.cr, self.demo_uid, [1], {'bank_ids': []}))
