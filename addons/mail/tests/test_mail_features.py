...
class test_mail(TestMail):
    ...
    def test_000_alias_setup(self):
        ...
        self.assertEqual(self.user_valentin.alias_name, self.user_valentin.login, "Login should be used as alias")
        ...
        self.assertEqual(self.user_pagan.alias_name, 'plmarchant', "If login is an email, the alias should keep only the local part")
        ...
        self.assertEqual(self.user_barty.alias_name, 'b4r+_-_r3wl-', 'Disallowed chars should be replaced by hyphens')
    ...
    def test_20_message_post(self):
        ...
        for sent_email in sent_emails:
            ...
            self.assertEqual(sent_email['reply_to'], '"YourCompany \\"Pigs\\" !ù $%-" <group+pigs@schlouby.fr>',
        ...
        test_emailto = ['Administrator <a@a>', 'Bert Tartopoils <b@b>', 'Carine Poilvache <c@c>', 'D\xe9d\xe9 Grosbedon <d@d>']
    ...
    def test_40_track_field(self):
        ...
        self.assertEqual(last_msg.subtype_id.id, mt_group_public_id, 'tracked: message should be linked to mt_group_public_id')
        self.assertIn('Group changed', last_msg.body, 'tracked: message body does not hold the subtype description')
        self.assertIn('Administration/Settings\u2192', _strip_string_spaces(last_msg.body), 'tracked: message body does not hold always tracked field')
