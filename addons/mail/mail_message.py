...
class mail_message(osv.Model):
    ...
    def _message_read_add_expandables(self, cr, uid, messages, message_tree, parent_tree,
        ...
        if thread_level == 0:
            ...
            exp_domain = domain + ['!', ('id', 'child_of', message_unload_ids + list(parent_tree.keys()))]
    ...
    def message_read(self, cr, uid, ids=None, domain=None, message_unload_ids=None,
        ...
        if thread_level:
            for key, message_id_list in parent_tree.items():
        ...
        parent_list = list(parent_tree.items())
    ...
    def check_access_rule(self, cr, uid, ids, operation, context=None):
        ...
        notified_ids = []
        if operation == 'create':
            parent_ids = [message.get('parent_id') for mid, message in message_values.items()
        ...
        if operation == 'read':
            ...
            for doc_model, doc_ids in list(model_record_ids.items()):
        ...
        for model, doc_ids in list(model_record_ids.items()):
