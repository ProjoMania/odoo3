...
class account_analytic_account(osv.osv):
    def _invoiced_calc(self, cr, uid, ids, name, arg, context=None):
        ...
        for account in self.browse(cr, uid, ids, context=context):
            invoice_ids = [_f for _f in list(set(account_to_invoice_map.get(account.id, []))) if _f]
...
class account_analytic_line(osv.osv):
    ...
    def invoice_cost_create(self, cr, uid, ids, data=None, context=None):
        ...
        for (key_id, company_id, currency_id), analytic_lines in list(invoice_grouping.items()):
            ...
            for (product_id, uom, user_id, factor_id, account, journal_type), lines_to_invoice in list(invoice_lines_grouping.items()):
