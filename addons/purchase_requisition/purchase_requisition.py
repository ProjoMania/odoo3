...
class purchase_requisition(osv.osv):
    ...
    def make_purchase_order(self, cr, uid, ids, partner_id, context=None):
        ...
        for requisition in self.browse(cr, uid, ids, context=context):
            if not requisition.multiple_rfq_per_supplier and supplier.id in [x for x in [rfq.state != 'cancel' and rfq.partner_id.id or None for rfq in requisition.purchase_ids] if x]:
    ...
    def generate_po(self, cr, uid, ids, context=None):
        ...
        for tender in self.browse(cr, uid, ids, context=context):
            ...
            for supplier, product_line in list(id_per_supplier.items()):
