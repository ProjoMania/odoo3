        ...
        for definition, goals in list(goals_by_definition.items()):
            ...
            if definition.computation_mode == 'manually':
                ...
                for goal in goals:
                    ...
                    if result is not None and type(result) in (float, int, int):
                ...
                if definition.computation_mode == 'count' and definition.batch_mode:
                    ...
                    for (start_date, end_date), query_goals in list(subqueries.items()):
                        ...
                        for goal in [g for g in goals if g.id in list(query_goals.keys())]:
            ...
            for goal_id, value in list(goals_to_write.items()):
                if not value:
                    continue
