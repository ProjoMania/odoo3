...
class project(osv.osv):
    ...
    def map_tasks(self, cr, uid, old_project_id, new_project_id, context=None):
        ...
        self.write(cr, uid, [new_project_id], {'tasks':[(6,0, list(map_task_id.values()))]})
    ...
    def _schedule_header(self, cr, uid, ids, force_members=True, context=None):
        ...
        for project in self.browse(cr, uid, ids, context=context):
            ...
            for key, vals in list(resource_objs.items()):
                result +='''
...
class task(osv.osv):
    ...
    def duplicate_task(self, cr, uid, map_ids, context=None):
        ...
        for task in self.browse(cr, uid, list(map_ids.values()), context):
