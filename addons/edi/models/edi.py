...
class edi(osv.AbstractModel):
    ...
    def import_edi(self, cr, uid, edi_document=None, edi_url=None, context=None):
        ...
        if edi_url:
            ...
            edi_document = urllib.request.urlopen(edi_url).read()
...
class EDIMixin(object):
    ...
    def edi_export(self, cr, uid, records, edi_struct=None, context=None):
        ...
        if edi_struct is None:
            edi_struct = {}
        fields_to_export = list(edi_struct.keys())
        results = []
        for record in records:
    ...
    def edi_import(self, cr, uid, edi, context=None):
        ...
        for field_name, field_value in edi.items():
        ...
        for o2m_field, o2m_value in o2m_todo.items():
