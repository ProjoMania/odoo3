...
class PaypalForm(PaypalCommon):
    ...
    def test_10_paypal_form_render(self):
        ...
        form_values = {
            ...
            'return': '%s' % urllib.parse.urljoin(self.base_url, PaypalController._return_url),
            'notify_url': '%s' % urllib.parse.urljoin(self.base_url, PaypalController._notify_url),
            'cancel_return': '%s' % urllib.parse.urljoin(self.base_url, PaypalController._cancel_url),
        }
    ...
    def test_20_paypal_form_management(self):
        ...
        paypal_post_data = {
            ...
            'receiver_email': 'tde+paypal-facilitator@openerp.com',
            ...
            'mc_currency': 'EUR',
            'shipping': '0.00',
            'payer_email': 'tde+buyer@openerp.com',
