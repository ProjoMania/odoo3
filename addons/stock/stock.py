...
class stock_picking(osv.osv):
    ...
    def _get_top_level_packages(self, cr, uid, quants_suggested_locations, context=None):
        ...
        quants_to_compare = list(quants_suggested_locations.keys())
        for pack in list(set([x.package_id for x in list(quants_suggested_locations.keys()) if x and x.package_id])):
            loop = True
            test_pack = pack
            good_pack = False
    ...
    def _prepare_pack_ops(self, cr, uid, picking, quants, forced_qties, context=None):
        ...
        for quant, dest_location_id in list(quants_suggested_locations.items()):
        ...
        prevals = {}
        for key, qty in list(qtys_grouped.items()):
    ...
    def _create_extra_moves(self, cr, uid, picking, context=None):
        ...
        for op in picking.pack_operation_ids:
            for product_id, remaining_qty in list(operation_obj._get_remaining_prod_quantities(cr, uid, op, context=context).items()):
...
class stock_move(osv.osv):
    ...
    def action_confirm(self, cr, uid, ids, context=None):
        ...
        for state, write_ids in list(states.items()):
            if len(write_ids):
                self.write(cr, uid, write_ids, {'state': state}, context=context)
        #assign picking in batch for all confirmed move that share the same details
        for key, move_ids in list(to_assign.items()):
...
class stock_inventory(osv.osv):
    ...
    def _get_inventory_lines(self, cr, uid, inventory, context=None):
        ...
        for product_line in cr.dictfetchall():
            ...
            for key, value in list(product_line.items()):
                if not value:
