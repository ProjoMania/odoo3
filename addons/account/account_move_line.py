...
class account_move_line(osv.osv):
    ...
    def _query_get(self, cr, uid, obj='l', context=None):
        ...
        if not context.get('fiscalyear'):
            ...
            if isinstance(context['fiscalyear'], int):
    ...
    def _default_get(self, cr, uid, fields, context=None):
        ...
        if context.get('journal_id'):
            ...
            if isinstance(data.get('partner_id'), int):
    ...
    def _get_move_from_reconcile(self, cr, uid, ids, context=None):
        ...
        move_line_ids = []
        if move:
            move_line_ids = self.pool.get('account.move.line').search(cr, uid, [('move_id','in',list(move.keys()))], context=context)
    ...
    def create(self, cr, uid, vals, context=None, check=True):
        ...
        if 'period_id' in context and not isinstance(context.get('period_id', ''), int):
