...
class TestTax(TransactionCase):
    ...
    def test_programmatic_tax(self):
        ...
        self.assertEqual(tax_detail['amount'], 24.0)
        self.assertEqual(res['total_included'], 124.0)
    ...
    def test_percent_tax(self):
        ...
        tax_detail = res['taxes'][0]
        self.assertEqual(tax_detail['amount'], 10.0)
        self.assertEqual(res['total_included'], 110.0)
